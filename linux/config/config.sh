...
alias cls="reset"
alias flp="sudo usbreset 'Scarlett Solo USB' && sudo rm -rf /var/crash/*"
alias up="sudo snap refresh && sudo apt update -y && sudo apt upgrade -y && sudo apt autoremove -y && omz update && node-update"
